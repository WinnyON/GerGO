...
{
    class RowComparerDesc : IComparer<string>
    {
        string _type;
        int _indexOutX, _indexOutY;
        int _indexInX, _indexInY;
        public RowComparerDesc(string type, int indexOutX, int indexOutY, int indexInX, int indexInY)
        {
            _type = type;
        ...
        public int Compare(string? x, string? y)
        {
            ...
            if (Validator.IsGreater(val1, val2, _type)) return -1;
            return 1;
        }
    }
}
